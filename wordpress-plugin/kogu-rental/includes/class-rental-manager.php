...
class Kogu_Rental_Manager {
    ...
    public static function confirm_return( $rental_id, $damage_fee = 0, $late_fee_override = null ) {
        global $wpdb;
        ...
        Kogu_Email_Handler::send_return_complete( $rental_id, $total_charge, $late_fee_total, $damage_fee );
